...
class __TwigTemplate_a52cf49165b47ffe16fd6b360b81fcb77d70aa1aef9ca45ddec73ceaa2077189 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "comfirm_password", [], "any", false, false, false, 12), 'row', ["label" => "Comfirmation du mot de passe", "attr" => ["placeholder" => "Comfirmer votre Password"]]);
        echo "
...
";
    ...
    {
        return array (  95 => 15,  89 => 12,  85 => 11,  81 => 10,  77 => 9,  72 => 7,  68 => 5,  58 => 4,  35 => 1,);
    }
...
{% block body %}
    ...
    {{ form_row(form.username, {'label': 'Nom d\\'utilisateur', 'attr': {'placeholder': \"Renseigner votre userName\"} })}}
    {{ form_row(form.email, {'label': 'Adresse Email','attr': {'placeholder': \"Renseigner votre email\"} })}}
    {{ form_row(form.password, {'label': 'Mot de passe','attr': {'placeholder': \"Renseigner votre Password\"} })}}
    {{ form_row(form.comfirm_password, {'label': 'Comfirmation du mot de passe','attr': {'placeholder': \"Comfirmer votre Password\"} })}}
...
{% endblock %} 
", "security/registration.html.twig", "C:\\Users\\Utilisateur\\Desktop\\youtubeSymfony\\demo1\\templates\\security\\registration.html.twig");
    }
}
